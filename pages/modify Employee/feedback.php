   ...
   // Check if User Coming FromARequest
    if ($_SERVER[ 'REQUEST_METHOD'] == 'POST'){
       ...
       // If No Errors Send The Email[mail(To, Subject, Message, Headers, Parameters)]
            $headers  = 'Feedback from user that owened phone number' .$Pnumber ;
            $myEmail  = 'ak1021759@gmail.com';
            $subject  = 'report';
            if (empty ($formErrors)){
                      ...
                      <?php }?>
                        ...
                        <?php 
                          ...
                          <div class="mb-3">
                            ...
                            <input type="text" id="disabledTextInput" class="form-control" name="Pnumber" placeholder="your phone number" required>
                          </div>
                          <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <input type="text" id="disabledTextInput" class="form-control" name="name" placeholder="your name" required>
                          </div>
                          <div class="mb-3">
